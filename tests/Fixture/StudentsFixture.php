...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'students_ibfk_1' => ['type' => 'foreign', 'columns' => ['class_id'], 'references' => ['clss', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'students_ibfk_2' => ['type' => 'foreign', 'columns' => ['teacher_id'], 'references' => ['teachers', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'class_id' => 1,
            'teacher_id' => 1,
            'created' => '2017-02-19 14:03:11',
            'modified' => '2017-02-19 14:03:11'
        ],
    ];
}
